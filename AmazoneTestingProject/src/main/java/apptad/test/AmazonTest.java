...
public class AmazonTest {
  ...
  @Test(priority = 1)
  public void AM_01() {
	  String efile="AmazonTestCase.xlsx";
	  String email=GetData.fromExcel(efile,"Data",0, 0);
	  String pass=GetData.fromExcel(efile,"Data",0, 1);
  ...
  public void AM_02() {
	  LoginPage page=PageFactory.initElements(webDriver, LoginPage.class);
		...
		Handlers.ActionsmoveToElement(ele, webDriver);
	     page.clickOnSignIn();
	     page.enterEmailOrMobileNum("umesh9898");
	     page.clickOnContine();
  ...
  public void AM_03() {
	  ...
	  LoginPage page=PageFactory.initElements(webDriver, LoginPage.class);
		...
		Handlers.ActionsmoveToElement(ele, webDriver);
	     ...
	     page.enterEmailOrMobileNum(email);
	     page.clickOnContine();
	     page.enterPassword("umeshtiwari");
	     page.clickOnLogin();
